...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"check\": () => (/* binding */ check),\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index */ \"./src/index.js\");\n\n\n\n\nif (localStorage.getItem('todoLists') !== null) {\n    let getLocal = localStorage.getItem('todoLists');\n    let todoList = JSON.parse(getLocal);\n    console.log(todoList)\n    // display(todoList);\n}\n\nfunction check() {\n    const checkBox = document.querySelectorAll('.small-box');\n    console.log(_index__WEBPACK_IMPORTED_MODULE_0__.todoLists);\n    \n    checkBox.forEach((item,i) => {\n        // console.log(item);\n        item.addEventListener('change', () => {\n            if(item.checked) {\n                _index__WEBPACK_IMPORTED_MODULE_0__.todoLists[i].completed = true;\n\n                const line = document.querySelectorAll('.item')\n                console.log(line[i]);\n                console.log(_index__WEBPACK_IMPORTED_MODULE_0__.todoLists[i]);\n                line[i].style.textDecoration = 'line-through';\n                // addLocalStorage();\n\n            }else if (item.checked == false) {\n                _index__WEBPACK_IMPORTED_MODULE_0__.todoLists[i].completed = false;\n                const line = document.querySelectorAll('.item')\n                line[i].style.textDecoration = 'none';\n                console.log(_index__WEBPACK_IMPORTED_MODULE_0__.todoLists[i]);\n                // addLocalStorage();\n            }\n        })\n        \n    })    \n}\n\n\n\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ('check');\n\n//# sourceURL=webpack://webpack-demo/./src/script.js?");
